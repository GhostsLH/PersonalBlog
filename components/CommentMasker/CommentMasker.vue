		...
		<uni-popup ref="popup" :mask-click="false" type="bottom">
			...
			<view class="popup-wrapper">
				...
				<view class="popup-content">
					<textarea class="popup-content-textrea" v-model.trim="commentsVal" placeholder="请输入评论内容" maxlength="200"></textarea>
...
<script>
	export default {
		...
		// },
		watch: {
			showPopup(newVal) {		//	监听卡扣的变化，如果有为true那就打开弹窗，反之关闭弹窗
